from flaskApp.config import OCCUPANCY_HOURS
from flaskApp.apps.utils.time_utils import get_X_hours_ago_dt, dt_to_milliseconds

from ecobeeApp.utils import farenheitX10_to_degrees
